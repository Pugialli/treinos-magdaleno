  ...
  'relative w-full rounded-lg p-4 [&>svg~*]:pl-7 [&>svg+div]:translate-y-[-3px] [&>svg]:absolute [&>svg]:left-4 [&>svg]:top-4 [&>svg]:text-foreground',
  {
    variants: {
      variant: {
        ...
        destructive:
          // 'border border-destructive/70 bg-destructive/70 text-white [&>svg]:text-white',
          'border border-destructive/35 bg-destructive/15 text-destructive [&>svg]:text-destructive',
        success:
